...
import com.nbe3.domain.global.PASSWORD
import com.nbe3.domain.user.UserReader
import com.nbe3.domain.user.createUserWithId
...
class AuthenticatorTest : BehaviorSpec({
    ...
    Given("이메일이 유효하지 않은 경우") {
        ...
        every { userReader.read(any<Long>()) } throws UserNotFoundException.EXCEPTION
