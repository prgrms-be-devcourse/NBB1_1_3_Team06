...
class CommentWriterMismatchException private constructor (errorCode: CommentErrorCode) : DomainException(errorCode) {
    companion object {
        val EXCEPTION: DomainException =
            CommentWriterMismatchException(CommentErrorCode.COMMENT_WRITER_MISMATCH)
    }
}
