...
class CommentNotFoundException private constructor (errorCode: CommentErrorCode) : DomainException(errorCode) {
    companion object {
        val EXCEPTION: DomainException =
            com.nbe2.domain.posts.exception.CommentNotFoundException(CommentErrorCode.COMMENT_NOT_FOUND)
    }
}
