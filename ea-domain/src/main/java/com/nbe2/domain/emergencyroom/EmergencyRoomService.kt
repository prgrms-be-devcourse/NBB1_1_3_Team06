...
class EmergencyRoomService(
        ...
        private val realTimeEmergencyRoomInfoCacheManager:
    ...
    fun getRealTimeEmergencyRooms(
        ...
        val realTimeInfos: List<RealTimeEmergencyRoomInfo> =
    ...
    fun directionsEmergencyRoom(
        ...
        val byHospitalLocation: Coordinate =
                emergencyRoomReader.readCoordinate(hospitalName)
        val latitudeAndLongitude: String =
                byHospitalLocation.convertorLatitudeAndLongitude()
        return emergencyRoomDirections.directionsEmergencyRoom(
                myLocation,
    ...
    fun getEmergencyRoomDetail(
        ...
        val realTimeEmergencyRoomWithDistance:
                RealTimeEmergencyRoomWithDistance =
                distanceCalculator.calculateDistance(
                        coordinate,
                        realTimeEmergencyRoomInfo,
                )
        return EmergencyRoomDetailInfo.create(
                emergencyRoom,
                realTimeEmergencyRoomWithDistance,
        )
    }
