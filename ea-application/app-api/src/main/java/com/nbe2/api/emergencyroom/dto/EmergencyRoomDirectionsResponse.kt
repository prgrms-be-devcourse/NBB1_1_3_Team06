...
data class EmergencyRoomDirectionsResponse(
    ...
    companion object {
        fun to(info: EmergencyRoomDirectionsInfo): EmergencyRoomDirectionsResponse {
        ...
        private fun convertRoute(route: EmergencyRoomDirectionsInfo.Route): Route {
            val traoptimalList = route.traoptimal.map { convertTraoptimal(it) }
            return Route(traoptimalList)
        }

        private fun convertTraoptimal(traoptimal: EmergencyRoomDirectionsInfo.Traoptimal): Traoptimal {
            return Traoptimal(
        ...
        private fun convertSummary(summary: EmergencyRoomDirectionsInfo.Summary?): Summary? {
            return summary?.let {
                Summary(
        ...
        private fun convertSection(section: EmergencyRoomDirectionsInfo.Section): Section {
            return Section(
        ...
        private fun convertGuide(guide: EmergencyRoomDirectionsInfo.Guide): Guide {
            return Guide(
        ...
        private fun convertStart(start: EmergencyRoomDirectionsInfo.Start): Start {
            return Start(
