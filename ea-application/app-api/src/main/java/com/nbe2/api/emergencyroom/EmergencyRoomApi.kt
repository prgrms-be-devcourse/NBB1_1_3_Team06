...
class EmergencyRoomApi(private val emergencyRoomService: EmergencyRoomService) {
    ...
    fun getRealTimeEmergencyRooms(
        ...
        val responses: List<RealTimeEmergencyRoomResponse> =
                emergencyRoomService
                        .getRealTimeEmergencyRooms(
    ...
    fun saveSearEmergency(hospitalName: String): Response<List<String>> {
        val emergencyRoomListForName: List<String> =
    ...
    fun directionsEmergency(
        ...
        val emergencyRoomDirectionsInfo: EmergencyRoomDirectionsInfo =
                emergencyRoomService.directionsEmergencyRoom(
                        myLocation,
                        hospitalName,
                )
    ...
    fun getEmergencyRooms(
        ...
        val responses: List<EmergencyRoomMapResponse> =
                emergencyRoomService
                        .getEmergencyRooms(
                                Coordinate.of(longitude, latitude),
                                distance,
    ...
    fun getEmergencyRoomDetail(
        ...
        val emergencyRoomDetail: EmergencyRoomDetailInfo =
