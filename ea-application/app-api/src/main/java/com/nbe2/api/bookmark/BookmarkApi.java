...
public class BookmarkApi {
    ...
    public Response<Void> addBookmark(
        ...
        bookmarkService.saveBookmark(emergencyRoomId, userPrincipal.getUserId());
    ...
    public Response<BookmarkReadResponse> getBookmark(
        ...
        BookmarkReadResponse bookmarkReadResponse =
                BookmarkReadResponse.from(bookmarkService.readBookmark(userPrincipal.getUserId()));
    ...
    public Response<Void> deleteBookmark(
            ...
            @AuthenticationPrincipal UserPrincipal userPrincipal) {
        bookmarkService.deleteBookmark(emergencyRommId, userPrincipal.getUserId());
        return Response.success();
    }
}
