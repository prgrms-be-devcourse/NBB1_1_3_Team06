package com.nbe3.api.global.aop
...
class LogAspect {
    ...
    @Pointcut("execution(* com.nbe3.domain..*(..)) || execution(* com.nbe3.infra..*(..)) && !execution(* com.nbe3.common..*(..))")
    fun all() {}

    @Pointcut("execution(* com.nbe3.api..*Api.*(..)) && !execution(* com.nbe3.api.HealthCheckApi..*(..))")
    fun controller() {}
